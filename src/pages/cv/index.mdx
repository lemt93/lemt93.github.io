...
### Tam Minh Le
- 4+ years of experience of working as front-end engineer with strong fundamentals of JS core
- About half of year of working with Python, Linux system, networking and virtualization technologies
- Familiar and experienced working with FE libraries/frameworks (Nuxt/Vue, React, Ember)
- Familiar with FE dev tools, such as: webpack/babel, CSS preprocessors (Sass/PostCSS)
- Good English communication, both written and verbal
- Having strong urge to learn, to build applications with JS/NodeJS

<Profile />

# Relevant Work Experience
### GoBear VN
(*July 2020 - Now*) --- **Senior/Lead FE Engineer**
  - Using Nuxt/Vue to Build Purchase Form/flow that highly customizable by the product team, also providing end-user quickest way to customize their plan while filling their policy
  ...
  - Refactoring codebase to unify 2 branches of 2 products into one. The purpose is to provide flexibility, convenient ways configuring products and ease of deployment.
...
### KMS Technology
#### Ceterus
(*May 2020 - June 2020*) --- **Senior/TechLead FE Engineer**
...
(*June 2019 - Mar 2020*) --- **BE/System Engineer**
  ...
  - Troubleshooting VMs and network errors, working closely with KMS IT
team to provide smooth infrastructure for the internal team.

#### Digital Picture - Revegy
(*Oct 2018 - May 2019*) --- **Senior/TechLead FE Engineer/Acting Scrum Master**
